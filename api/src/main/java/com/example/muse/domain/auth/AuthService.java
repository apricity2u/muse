...
public class AuthService {
     ...
     *
     * 인증 객체에서 OAuth2 제공자와 사용자 정보를 추출하여 기존 회원을 조회하거나, 없을 경우 신규 회원을 등록한 뒤 JWT 액세스 및 리프레시 토큰을 발급합니다.
     *
     * @param authentication OAuth2 인증 정보를 포함한 Authentication 객체
     * @return 발급된 JWT 액세스 및 리프레시 토큰이 담긴 TokenDto
     */
     ...
     * @return 생성된 액세스 토큰과 리프레시 토큰이 포함된 TokenDto 객체
     */
    @Transactional
    ...
    /**
     * OAuth2 제공자 정보를 기반으로 새로운 회원을 생성하고 저장합니다.
     *
     * @param provider OAuth2 인증 제공자
     * @param sub 제공자에서 발급한 고유 사용자 식별자
